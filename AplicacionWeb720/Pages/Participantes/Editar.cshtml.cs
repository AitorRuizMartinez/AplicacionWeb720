                    ...
                    using (SqlCommand command = new SqlCommand(sql, connection))
                    {
                        ...
                        using (SqlDataReader reader = command.ExecuteReader())
                        {
                            if (reader.Read())
                            {
                                ...
                                infoParticipantes.altura = "" + reader.GetInt32(5);
                                infoParticipantes.peso = "" + reader.GetInt32(6);
                                infoParticipantes.fecha = reader.GetInt32(7);
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    String sql = "UPDATE participantes " +
                        "SET nombre=@nombre, apellidos=@apellidos, email=@email, telefono=@telefono, altura=@altura, peso=@peso, fecha=@fecha" +
